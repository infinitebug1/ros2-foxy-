...
def generate_launch_description():
    ...
    robot_control_dir = get_package_share_directory('turn_on_wheeltec_robot')
    ...
    wheeltec_robot = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(robot_control_launch_dir, 'turn_on_wheeltec_robot.launch.py')),
    )
    wheeltec_lidar = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(robot_control_launch_dir, 'wheeltec_lidar.launch.py')),
    )
    # Specify the actions
